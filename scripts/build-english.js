...
const PRESERVED = [
  ...
  { tag: '问候', prompt: '想问对方「你好吗？」你会说：', options: ['How are you?', 'What is it?', 'Where are you?', 'Who is it?'], answer: 0 },
  ...
  { tag: '游戏', prompt: '想邀请小伙伴一起玩：', options: ["Let's play!", 'Good night!', 'I am tired.', 'See you!'], answer: 0 },
  { tag: '饮食', prompt: '在餐厅想点一份米饭：', options: ["I'd like some rice, please.", 'I am rice.', 'Rice is red.', 'Goodbye!'], answer: 0 },
...
const NEW_ITEMS = [
  ...
  { tag: '问候', prompt: '放学路上遇见邻居，想问好：', options: ['Hello!', 'Good night!', 'Thank you!', 'Sorry!'], answer: 0 },
  ...
  { tag: '问候', prompt: '很久没见的朋友，你想问近况：', options: ['How are you?', 'What color?', 'How old?', 'Where book?'], answer: 0 },
  ...
  { tag: '问候', prompt: '想问问同学今天过得怎么样：', options: ['How are you today?', 'What is today?', 'Where today?', 'Who today?'], answer: 0 },
  ...
  { tag: '学校', prompt: '找不到铅笔了，想问同桌：', options: ['Do you have a pencil?', 'I am a pencil.', 'Pencil is red.', 'Good night!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Sit down, please.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '想告诉老师作业写完了：', options: ['I finished my homework.', 'I am homework.', 'Homework is good.', 'Goodbye!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Stand up, please.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '想借同学的尺子：', options: ['Can I use your ruler?', 'I am your ruler.', 'Ruler is big.', 'Good night!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Be quiet, please.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '课堂上没听清楚，想问老师：', options: ['Pardon?', 'Goodbye!', 'Thank you!', 'Sorry!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Close your books.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '想告诉老师你生病了不能跑步：', options: ["I'm not feeling well.", 'I am well.', 'Well is good.', 'Good night!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Line up, please.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '值日时想问垃圾扔哪里：', options: ['Where is the bin?', 'I am the bin.', 'Bin is good.', 'Good morning!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Hand in your homework.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '想告诉同学下一节是体育课：', options: ["It's PE class.", 'I am PE.', 'PE is good.', 'Good night!'], answer: 0 },
  ...
  { tag: '学校', prompt: '想问问今天学第几课：', options: ['Which lesson is it?', 'I am lesson.', 'Lesson is good.', 'Good morning!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Read after me.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '想告诉老师你要去洗手间：', options: ['May I go to the toilet?', 'I am toilet.', 'Toilet is good.', 'Good night!'], answer: 0 },
  ...
  { tag: '学校', prompt: '想告诉同学图书馆在二楼：', options: ['The library is on the second floor.', 'I am library.', 'Library is good.', 'Good night!'], answer: 0 },
  { tag: '学校', prompt: '老师说的是：', heard: 'Take out your notebooks.', sub: '你怎么回应？', options: ['OK.', 'No.', 'Goodbye.', 'Sorry.'], answer: 0 },
  { tag: '学校', prompt: '美术课想借彩色笔：', options: ['Can I borrow your crayons?', 'I am crayons.', 'Crayons are good.', 'Good morning!'], answer: 0 },

  // 游戏 (18)
  { tag: '游戏', prompt: '想邀请同学一起跳绳：', options: ["Let's skip rope!", 'Good night!', 'I am tired.', 'See you!'], answer: 0 },
  ...
  { tag: '游戏', prompt: '想提议玩捉迷藏：', options: ["Let's play hide and seek!", 'Good night!', 'I am hide.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '游戏', prompt: '想邀请朋友一起搭积木：', options: ["Let's build blocks!", 'Good night!', 'I am blocks.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '游戏', prompt: '想邀请同学一起下棋：', options: ["Let's play chess!", 'Good night!', 'I am chess.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '游戏', prompt: '想提议一起玩飞盘：', options: ["Let's play frisbee!", 'Good night!', 'I am frisbee.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '游戏', prompt: '想邀请朋友一起画画：', options: ["Let's draw together!", 'Good night!', 'I am draw.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '饮食', prompt: '在食堂想点一份沙拉：', options: ["I'd like a salad, please.", 'I am salad.', 'Salary is good.', 'Goodbye!'], answer: 0 },
  { tag: '饮食', prompt: '想告诉妈妈你饿了：', options: ["I'm hungry.", 'I am hungry.', 'Hungry is good.', 'Good morning!'], answer: 0 },
  { tag: '饮食', prompt: '对方说的是：', heard: 'Are you hungry?', sub: '你确实饿了，怎么说？', options: ['Yes, I am.', 'No, goodbye.', 'I am fine.', 'Good night!'], answer: 0 },
  { tag: '饮食', prompt: '想点一杯橙汁：', options: ['Can I have orange juice?', 'I am orange.', 'Orange is good.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '饮食', prompt: '在餐厅想点鸡肉：', options: ["I'd like chicken, please.", 'I am chicken.', 'Chicken is red.', 'Goodbye!'], answer: 0 },
  { tag: '饮食', prompt: '想告诉同学这个很好吃：', options: ["It's delicious!", 'I am delicious.', 'Delicious is good.', 'Good morning!'], answer: 0 },
  ...
  { tag: '饮食', prompt: '想问问这是什么菜：', options: ['What is this dish?', 'I am dish.', 'Dish is good.', 'Good morning!'], answer: 0 },
  ...
  { tag: '饮食', prompt: '想点一份鸡蛋：', options: ["I'd like an egg, please.", 'I am egg.', 'Egg is red.', 'Goodbye!'], answer: 0 },
  { tag: '饮食', prompt: '想告诉朋友你渴了：', options: ["I'm thirsty.", 'I am thirsty.', 'Thirsty is good.', 'Good morning!'], answer: 0 },
  { tag: '饮食', prompt: '对方说的是：', heard: 'Pass the salt, please.', sub: '你把盐递过去，说：', options: ['Here you are.', 'Goodbye.', 'Sorry.', 'No.'], answer: 0 },
  { tag: '饮食', prompt: '在水果店想买香蕉：', options: ['I want some bananas.', 'I am bananas.', 'Bananas are good.', 'Good night!'], answer: 0 },
  ...
  { tag: '请求', prompt: '想借同学的胶棒：', options: ['May I use your glue stick?', 'I am glue.', 'Glue is good.', 'Goodbye!'], answer: 0 },
  ...
  // 介绍 (18)
  { tag: '介绍', prompt: '想告诉别人你来自北京：', options: ["I'm from Beijing.", 'I am Beijing.', 'Beijing is good.', 'Good night!'], answer: 0 },
  ...
  { tag: '介绍', prompt: '想介绍这是你妹妹：', options: ['This is my sister.', 'I am sister.', 'Sister is good.', 'Good morning!'], answer: 0 },
  { tag: '介绍', prompt: '对方说的是：', heard: 'Where are you from?', sub: '你来自上海：', options: ["I'm from Shanghai.", 'I am fine.', 'Good night.', 'Thank you.'], answer: 0 },
  { tag: '介绍', prompt: '想告诉新同学你在一年级：', options: ["I'm in Grade One.", 'I am grade.', 'Grade is good.', 'Goodbye!'], answer: 0 },
  { tag: '介绍', prompt: '对方说的是：', heard: 'Who is he?', sub: '他是你爸爸：', options: ["He's my dad.", 'I am dad.', 'Dad is good.', 'Good night!'], answer: 0 },
  { tag: '介绍', prompt: '想介绍你的宠物猫：', options: ['This is my cat.', 'I am cat.', 'Cat is good.', 'Good morning!'], answer: 0 },
  ...
  { tag: '介绍', prompt: '想告诉别人你喜欢足球：', options: ['I like football.', 'I am football.', 'Football is good.', 'Goodbye!'], answer: 0 },
  { tag: '介绍', prompt: '对方说的是：', heard: 'Is this your bag?', sub: '是的，是你的：', options: ['Yes, it is.', 'No, goodbye.', 'I am bag.', 'Good night!'], answer: 0 },
  { tag: '介绍', prompt: '想介绍你的好朋友 Lily：', options: ['This is my friend Lily.', 'I am Lily.', 'Lily is good.', 'Good morning!'], answer: 0 },
  ...
  { tag: '介绍', prompt: '想告诉别人你九岁了：', options: ["I'm nine.", 'I am nine.', 'Nine is good.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '介绍', prompt: '想介绍你的英语老师：', options: ['She is my English teacher.', 'I am teacher.', 'Teacher is good.', 'Good morning!'], answer: 0 },
  { tag: '介绍', prompt: '对方说的是：', heard: 'Nice to meet you!', sub: '你也礼貌回应：', options: ['Nice to meet you, too!', 'Good night!', 'Sorry!', 'No!'], answer: 0 },
  { tag: '介绍', prompt: '想告诉别人你住在这附近：', options: ['I live near here.', 'I am near.', 'Near is good.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '日常', prompt: '想问这是什么颜色：', options: ['What color is it?', 'I am color.', 'Color is good.', 'Good morning!'], answer: 0 },
  ...
  { tag: '日常', prompt: '想数一数桌上有几本书：', options: ['How many books are there?', 'I am books.', 'Books are good.', 'Goodbye!'], answer: 0 },
  { tag: '日常', prompt: '对方说的是：', heard: 'How many apples?', sub: '有三个：', options: ['Three.', 'I am three.', 'Three is good.', 'Good night!'], answer: 0 },
  { tag: '日常', prompt: '想问现在几点了：', options: ['What time is it?', 'I am time.', 'Time is good.', 'Good morning!'], answer: 0 },
  { tag: '日常', prompt: '对方说的是：', heard: "It's three o'clock.", sub: '该去上课了，你说：', options: ["It's time for class.", 'Good night!', 'Sorry!', 'No!'], answer: 0 },
  { tag: '日常', prompt: '在商店想问这个多少钱：', options: ['How much is it?', 'I am much.', 'Much is good.', 'Goodbye!'], answer: 0 },
  ...
  { tag: '日常', prompt: '想告诉同学今天是星期一：', options: ["It's Monday.", 'I am Monday.', 'Monday is good.', 'Good morning!'], answer: 0 },
  ...
  { tag: '日常', prompt: '过马路前想看有没有车：', options: ['Look both ways.', 'I am ways.', 'Ways are good.', 'Good morning!'], answer: 0 },
  { tag: '日常', prompt: '对方说的是：', heard: 'The light is green.', sub: '可以走了：', options: ["Let's go.", 'Good night!', 'Sorry!', 'No!'], answer: 0 },
  { tag: '日常', prompt: '想告诉妈妈你在学校：', options: ["I'm at school.", 'I am school.', 'School is good.', 'Goodbye!'], answer: 0 },
];
